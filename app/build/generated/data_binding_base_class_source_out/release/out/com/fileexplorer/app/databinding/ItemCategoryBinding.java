...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivCategoryIcon,
      @NonNull LinearLayout layoutCategory, @NonNull TextView tvCategoryName) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout layoutCategory = (LinearLayout) rootView;
      ...
      return new ItemCategoryBinding((LinearLayout) rootView, ivCategoryIcon, layoutCategory,
          tvCategoryName);
    }
